...
export const metadata = {
   ...
   description: "Complete a free 10-minute AI Compliance Diagnostic across 5 dimensions. Receive your report by email.",
};
         ...
         <Container>
            <AnimatedSection from="none">
               <SectionHeading
                  ...
                  subtitle="Assess AI exposure in 10 minutes across 5 dimensions and receive a business-ready report by email"
               />
            </AnimatedSection>
            ...
            <AnimatedSection>
               <div className="bg-charcoal p-8 md:p-12 rounded-lg border border-slate/20 mb-20">
                  ...
                  <div className="max-w-4xl text-platinum/75 leading-relaxed space-y-4">
                     ...
                     <p>
                        Your diagnostic report is generated server-side and sent to your email with recommended next
                        steps.
                     </p>
                  </div>
               </div>
            ...
            <AnimatedSection>
               <div className="bg-charcoal p-6 md:p-10 rounded-lg border border-slate/20 mb-20">
                  <div className="max-w-3xl mx-auto text-center mb-10">
                     ...
                     <p className="text-lg text-platinum/70 leading-relaxed">
                        15 questions. 5 dimensions. 10 minutes. Submit once to receive your report by email.
                     </p>
                  </div>
                  <DiagnosticQuiz />
               </div>
            ...
            <AnimatedSection>
               <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-electric/5 to-gold/5 border border-slate/20 p-10 rounded-lg">
                  <h3 className="text-3xl font-serif font-bold text-white mb-4">
                     Need Help Reviewing Your Submission?
                  </h3>
